...
const RequestDetailsDialogSenior = ({ request, open, onOpenChange }: RequestDetailsDialogProps) => {
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-sm text-muted-foreground">Helper Name:</span>
...
export default RequestDetailsDialogSenior;